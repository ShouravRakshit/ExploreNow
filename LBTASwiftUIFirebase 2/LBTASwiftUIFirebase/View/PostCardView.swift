...
//        _viewModel = StateObject(wrappedValue: PostCardViewModel(post: post, onDelete: onDelete))
//    }
//    
//    var body: some View {
//        NavigationLink(destination: IndividualPostView(post: viewModel.postModel,
//                                                       likesCount: viewModel.likesCount,
//                                                       liked: viewModel.liked)) {
//            VStack(alignment: .leading, spacing: 0) {
//                // Header Section
//                HStack(spacing: 12) {
//                    if let imageUrl = URL(string: viewModel.postModel.userProfileImageUrl) {
...
//                            .clipShape(Circle())
//                            .overlay(
//                                Circle().stroke(AppTheme.lightPurple, lineWidth: 2)
//                            )
//                    } else {
...
//                        NavigationLink(destination: ProfileView(user_uid: viewModel.postModel.uid)) {
//                            Text(viewModel.postModel.username)
...
//                                .font(.system(size: 12))
//                            Text(viewModel.postModel.locationAddress)
//                                .font(.system(size: 12))
//                                .lineLimit(1)
//                        }
//                        .foregroundColor(AppTheme.secondaryText)
...
//                    Spacer()
//                    
//                    Text(viewModel.formatDate(viewModel.postModel.timestamp))
//                        .font(.system(size: 12))
//                        .foregroundColor(AppTheme.secondaryText)
//                    
...
//                
//                // Image Section
//                if !viewModel.postModel.imageUrls.isEmpty {
//                    TabView(selection: $viewModel.currentImageIndex) {
//                        ForEach(viewModel.postModel.imageUrls.indices, id: \.self) { index in
//                            if let imageUrl = URL(string: viewModel.postModel.imageUrls[index]) {
//                                WebImage(url: imageUrl)
//                                    .resizable()
//                                    .scaledToFill()
...
//                            Image(systemName: index <= viewModel.postModel.rating ? "star.fill" : "star")
//                                .font(.system(size: 12))
//                                .foregroundColor(index <= viewModel.postModel.rating ? .yellow : AppTheme.secondaryText)
//                        }
//                    }
//                }
//                .padding(.horizontal, 16)
...
//                
//                // Description
//                if !viewModel.postModel.description.isEmpty {
//                    Text(viewModel.postModel.description)
//                        .font(.system(size: 14))
...
//        .onAppear {
//            // Configure the ViewModel with the userManager obtained from Environment
